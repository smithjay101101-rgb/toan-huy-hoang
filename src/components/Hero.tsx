    ...
    >
      ...
      >
        <h1
          ...
          style={{
            // Korean Hangul blocks read visually larger/denser than Latin at
            // the same px, so KO gets its own smaller scale per the client;
            // other languages keep the big one.
            fontSize:
              locale === 'ko' ? 'clamp(44px, 7vw, 112px)' : 'clamp(64px, 9vw, 148px)',
